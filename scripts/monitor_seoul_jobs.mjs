...
// 화이트리스트가 아니라, 강사·교육직과 무관한 직군을 제외하는 블랙리스트 방식.
// 사용자는 "급여 받는 강사직"을 찾으므로 무급 봉사자·교원자격직·행정직도 제외한다.
const EXCLUDE_JOBS = new RegExp([
  // 시설·행정·기능직
  "영양사", "조리", "급식", "행정실", "행정직", "학원행정", "시설", "전산", "당직",
  "경비", "청소", "미화", "운전", "통학차량", "회계", "사무원", "보안", "기계",
  "전기설비", "배움터지킴이", "학교보안관", "환경", "소독", "방역", "세무", "총무",
  "경리", "수위", "연구원", "실무사", "계약직원", "교육복지조정자", "복지조정",
  // 무급 봉사직 (사용자는 급여 강사직을 원함)
  "봉사자", "봉사직", "자원봉사",
  // 교원자격 필요직 (방과후·특기강사와 다름)
  "교원", "보건교사", "특수교사", "영양교사", "결원대체", "결원 대체",
  // 상담·기타
  "상담사", "상담원", "외부상담",
  // 학생 대상 모집 (구직이 아님)
  "참가자", "수강생"
